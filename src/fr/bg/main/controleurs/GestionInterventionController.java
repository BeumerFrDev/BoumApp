...
public class GestionInterventionController implements Initializable {
 ...
 @FXML  private void close_app() {
    ...
    public void gotoGestionIntervention() {
            ...
            adminView = (TabPanInterventionsController) replaceSceneContent("vues/Interventions/TabPanIntervention.fxml", 1);
    ...
    public void gotoGestionRessources() {
            ...
            adminView = (TabPanRessourcesController) replaceSceneContent("vues/Ressouces/TabPanRessources.fxml", 1);
